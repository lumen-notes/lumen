      ...
      >
        <Drawer.Root open={isEditing} onOpenChange={(open) => setIsEditing(open)}>
          ...
          <Drawer.Portal>
            ...
            <Drawer.Content className="fixed bottom-0 left-0 right-0 flex h-[94svh] flex-col rounded-t-lg bg-bg-overlay outline-none ring-1 ring-border-secondary dark:ring-0">
