  ...
  return (
    <div className="relative">
      ...
      <input
        ref={ref}
        className={cx(
          "focus-ring h-10 w-full rounded-md bg-bg-secondary pl-10 [-webkit-appearance:none] [font-variant-numeric:inherit] placeholder:text-text-secondary focus-visible:bg-bg coarse:h-12 coarse:pl-12 [&:not(:focus-visible):hover]:ring-1 [&:not(:focus-visible):hover]:ring-inset [&:not(:focus-visible):hover]:ring-border-secondary",
