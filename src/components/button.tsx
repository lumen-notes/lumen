  ...
  ({ variant = "secondary", shortcut, className, children, ...props }, ref) => {
    const button = (
      <button
        ...
        type="button"
        className={cx(
          "focus-ring inline-flex h-8 cursor-default items-center justify-center rounded-sm px-3 font-bold leading-4 disabled:pointer-events-none disabled:opacity-50 coarse:h-10 coarse:px-4",
