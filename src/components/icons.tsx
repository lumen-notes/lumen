...
export function PinIcon16(props: IconProps) {
  return (
    <Icon size={16} {...props}>
      <path d="M3.883.806a1.95 1.95 0 0 1 3.05.376l1.309 2.18 3.772 1.1c1.423.415 1.881 2.203.833 3.251L10.811 9.75l4.97 4.97-1.061 1.06-4.97-4.97-2.037 2.037c-1.048 1.048-2.835.59-3.25-.833l-1.1-3.772-2.18-1.308a1.95 1.95 0 0 1-.377-3.051L3.883.806Zm1.765 1.148a.45.45 0 0 0-.704-.087L1.867 4.944a.45.45 0 0 0 .087.704l2.684 1.61 1.265 4.336a.45.45 0 0 0 .75.193l5.134-5.134a.45.45 0 0 0-.193-.75L7.258 4.638l-1.61-2.684Z" />
    </Icon>
  )
}
...
export function PinFillIcon16(props: IconProps) {
  return (
    <Icon size={16} {...props}>
      <path d="M6.934 1.182A1.95 1.95 0 0 0 3.883.806L.806 3.883a1.95 1.95 0 0 0 .376 3.05l2.18 1.309 1.1 3.772c.416 1.423 2.203 1.881 3.251.833l2.037-2.036 4.97 4.97 1.06-1.061-4.97-4.97 2.037-2.037c1.048-1.048.59-2.836-.833-3.25l-3.772-1.1-1.308-2.181Z" />
    </Icon>
  )
}
