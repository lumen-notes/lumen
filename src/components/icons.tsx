  ...
  return (
    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="m21.091 2.03.879.879a2.25 2.25 0 0 1 0 3.182l-8.646 8.645a2.25 2.25 0 0 1-1.045.592l-2.789.698a1.25 1.25 0 0 1-1.516-1.516l.698-2.789a2.25 2.25 0 0 1 .591-1.045L17.91 2.03a2.25 2.25 0 0 1 3.182 0ZM18.97 3.091a.75.75 0 0 1 1.06 0l.879.879a.75.75 0 0 1 0 1.06l-8.646 8.646a.75.75 0 0 1-.348.197l-2.384.596.596-2.384a.751.751 0 0 1 .197-.349l8.646-8.645Z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.75 3A3.75 3.75 0 0 0 2 6.75v11.5A3.75 3.75 0 0 0 5.75 22h11.5A3.75 3.75 0 0 0 21 18.25V14h-1.5v4.25a2.25 2.25 0 0 1-2.25 2.25H5.75a2.25 2.25 0 0 1-2.25-2.25V6.75A2.25 2.25 0 0 1 5.75 4.5H10V3H5.75Z"
      />
    </svg>
  )
}
