  ...
  return (
    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22.091 2.03a2.25 2.25 0 0 0-3.182 0l-8.189 8.19a2.25 2.25 0 0 0-.543.879l-1.072 3.215c-.326.977.604 1.907 1.58 1.581l3.216-1.072a2.25 2.25 0 0 0 .88-.543L22.97 6.09a2.25 2.25 0 0 0 0-3.182l-.879-.879ZM19.97 3.091a.75.75 0 0 1 1.06 0l.879.879a.75.75 0 0 1 0 1.06l-8.189 8.19a.751.751 0 0 1-.293.18l-2.741.914.914-2.74a.75.75 0 0 1 .18-.294l8.19-8.189Z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.75 3A3.75 3.75 0 0 0 1 6.75v10.5A3.75 3.75 0 0 0 4.75 21h14.5A3.75 3.75 0 0 0 23 17.25V12h-1.5v5.25a2.25 2.25 0 0 1-2.25 2.25H4.75a2.25 2.25 0 0 1-2.25-2.25V6.75A2.25 2.25 0 0 1 4.75 4.5H12V3H4.75Z"
      />
    </svg>
  )
}
