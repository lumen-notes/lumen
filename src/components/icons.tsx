...
export function EyeIcon16({ className, ...props }: IconProps) {
  return (
    <Icon size={16} className={cx("overflow-visible", className)} {...props}>
      <path d="M11 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" />
      <path d="M9 2c-2.004 0-3.743.919-5.075 1.96-1.337 1.046-2.33 2.265-2.859 2.986a1.77 1.77 0 0 0 0 2.108c.53.72 1.522 1.94 2.86 2.985C5.256 13.081 6.995 14 9 14s3.743-.919 5.075-1.96c1.337-1.046 2.33-2.265 2.859-2.986a1.771 1.771 0 0 0 0-2.108c-.53-.72-1.523-1.94-2.86-2.985C12.744 2.919 11.005 2 9 2ZM2.275 7.834c.487-.662 1.386-1.763 2.574-2.692C6.042 4.21 7.46 3.5 9 3.5c1.54 0 2.958.71 4.15 1.642 1.189.93 2.088 2.03 2.575 2.692a.271.271 0 0 1 0 .332c-.486.662-1.386 1.763-2.574 2.692C11.958 11.79 10.54 12.5 9 12.5c-1.54 0-2.958-.71-4.15-1.642-1.189-.93-2.088-2.03-2.575-2.692a.271.271 0 0 1 0-.332Z" />
      {/* <path d="M9 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3ZM9 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
      <path d="M4.39 4.872C3.12 5.922 2.2 7.151 1.732 7.846a.267.267 0 0 0 0 .308c.466.695 1.386 1.925 2.656 2.974C5.662 12.178 7.226 13 9 13c1.774 0 3.338-.821 4.61-1.872 1.27-1.05 2.19-2.279 2.657-2.974a.267.267 0 0 0 0-.308c-.466-.695-1.386-1.925-2.656-2.974C12.338 3.822 10.774 3 9 3c-1.774 0-3.338.821-4.61 1.872Zm-.956-1.156C4.857 2.54 6.75 1.5 9 1.5s4.143 1.04 5.566 2.216c1.425 1.176 2.438 2.536 2.947 3.295a1.767 1.767 0 0 1 0 1.978c-.51.76-1.522 2.119-2.947 3.295C13.143 13.46 11.25 14.5 9 14.5s-4.143-1.04-5.566-2.216C2.01 11.108.996 9.748.487 8.99a1.767 1.767 0 0 1 0-1.978c.51-.76 1.522-2.119 2.947-3.295Z" /> */}
    </Icon>
  )
}
...
export function PinIcon16(props: IconProps) {
  return (
    <Icon size={16} {...props}>
      <path d="M3.883.806a1.95 1.95 0 0 1 3.05.376l1.309 2.18 4.907 1.432a1.25 1.25 0 0 1 .534 2.083L10.811 9.75l4.97 4.97-1.061 1.06-4.97-4.97-2.873 2.873a1.25 1.25 0 0 1-2.083-.534L3.362 8.242l-2.18-1.308a1.95 1.95 0 0 1-.376-3.051L3.883.806Zm1.765 1.148a.45.45 0 0 0-.704-.087L1.867 4.944a.45.45 0 0 0 .087.704l2.684 1.61 1.477 5.066 6.209-6.209-5.066-1.477-1.61-2.684Z" />
    </Icon>
  )
}
...
export function PinFillIcon16(props: IconProps) {
  return (
    <Icon size={16} {...props}>
      <path d="M3.883.806a1.95 1.95 0 0 1 3.05.376l1.309 2.18 4.907 1.432a1.25 1.25 0 0 1 .534 2.083L10.811 9.75l4.97 4.97-1.061 1.06-4.97-4.97-2.873 2.873a1.25 1.25 0 0 1-2.083-.534L3.362 8.242l-2.18-1.308a1.95 1.95 0 0 1-.376-3.051L3.883.806Z" />
    </Icon>
  )
}
