...
export function PinIcon16(props: IconProps) {
  return (
    <Icon size={16} {...props}>
      <path d="M12.117.806a1.95 1.95 0 0 0-3.05.376l-1.309 2.18-4.907 1.432a1.25 1.25 0 0 0-.534 2.083L5.189 9.75l-4.97 4.97 1.061 1.06 4.97-4.97 2.873 2.873a1.25 1.25 0 0 0 2.083-.534l1.432-4.907 2.18-1.308a1.95 1.95 0 0 0 .376-3.051L12.117.806Zm-1.765 1.148a.45.45 0 0 1 .704-.087l3.077 3.077a.45.45 0 0 1-.087.704l-2.684 1.61-1.477 5.066-6.209-6.209 5.066-1.477 1.61-2.684Z" />
    </Icon>
  )
}
...
export function PinFillIcon16(props: IconProps) {
  return (
    <Icon size={16} {...props}>
      <path d="M12.117.806a1.95 1.95 0 0 0-3.05.376l-1.309 2.18-4.907 1.432a1.25 1.25 0 0 0-.534 2.083L5.189 9.75l-4.97 4.97 1.061 1.06 4.97-4.97 2.873 2.873a1.25 1.25 0 0 0 2.083-.534l1.432-4.907 2.18-1.308a1.95 1.95 0 0 0 .376-3.051L12.117.806Z" />
    </Icon>
  )
}
...
export function PinFillIcon12(props: IconProps) {
  return (
    <Icon size={12} {...props}>
      <path d="M6.93.693a1.25 1.25 0 0 1 1.881-.13l2.626 2.627a1.25 1.25 0 0 1-.13 1.88l-1.882 1.424-.624 2.893a1.25 1.25 0 0 1-2.105.62L4.876 8.187 1.218 11.844l-1.06-1.06 3.656-3.658-1.82-1.82c-.7-.7-.347-1.898.62-2.107l2.893-.623L6.93.693Z" />
    </Icon>
  )
}
...
export function PinIcon12(props: IconProps) {
  return (
    <Icon size={12} {...props}>
      <path d="M8.811.563a1.25 1.25 0 0 0-1.88.13l-1.424 1.882-2.893.623a1.25 1.25 0 0 0-.62 2.106l1.82 1.821-3.657 3.657 1.06 1.06 3.658-3.656 1.82 1.82c.7.7 1.898.347 2.106-.62l.624-2.893L11.307 5.07a1.25 1.25 0 0 0 .13-1.881L8.81.563Zm-2.443 3.361L7.954 1.827l2.22 2.22-2.099 1.585-.643 2.989-4.053-4.053 2.989-.644Z" />
    </Icon>
  )
}
