  ...
  return (
    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      ...
      <text
        ...
        fontSize="10px"
        fill="currentColor"
        className="font-mono font-bold leading-none text-bg-inset"
      >
        {date}
      </text>
    </svg>
...
export function PhoneIcon16() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 16 16" fill="currentColor" aria-hidden>
      <path d="M3.724.155A1.95 1.95 0 0 1 6.14 1.169l1.512 3.24-1.514 1.514c.851 1.89 2.049 3.088 3.94 3.94l1.513-1.515 3.24 1.512a1.95 1.95 0 0 1 1.014 2.416l-.6 1.699c-.426 1.21-1.668 2.016-2.992 1.745-3.246-.665-5.914-2.007-7.94-4.034C2.287 9.66.945 6.994.28 3.747.009 2.424.816 1.182 2.025.756l1.699-.6ZM4.78 1.804a.45.45 0 0 0-.558-.235l-1.699.6c-.569.2-.882.753-.775 1.277.618 3.01 1.842 5.396 3.625 7.18 1.783 1.783 4.17 3.007 7.18 3.624.524.108 1.076-.205 1.277-.774l.6-1.7a.45.45 0 0 0-.235-.557l-2.287-1.067-1.478 1.478-.46-.184C7.281 10.37 5.63 8.72 4.554 6.028L4.37 5.57l1.478-1.478-1.067-2.287Z" />
      {/* <path d="M12 1.5a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5H4a.5.5 0 0 1-.5-.5V2a.5.5 0 0 1 .5-.5h8ZM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4Z" />
