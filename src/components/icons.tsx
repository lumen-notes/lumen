...
export function GitHubIcon16() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 16 16" fill="var(--color-github)" aria-hidden>
...
export function TwitterIcon16() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 16 16" fill="var(--color-twitter)" aria-hidden>
